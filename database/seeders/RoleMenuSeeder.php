...
class RoleMenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table("role_menus")->insert([
            ...
            ["menu_id" => "67", "role_id" => "6"],
            ["menu_id" => "68", "role_id" => "6"],
            ["menu_id" => "69", "role_id" => "6"],
            ["menu_id" => "70", "role_id" => "6"],
            ["menu_id" => "71", "role_id" => "6"],
            ["menu_id" => "72", "role_id" => "6"],
            ["menu_id" => "73", "role_id" => "6"],
            ["menu_id" => "74", "role_id" => "6"],
            ["menu_id" => "75", "role_id" => "6"],
            ...
            ["menu_id" => "80", "role_id" => "5"],
            ["menu_id" => "81", "role_id" => "5"],
            ["menu_id" => "82", "role_id" => "5"],
            ["menu_id" => "83", "role_id" => "5"],
            ["menu_id" => "84", "role_id" => "5"],
            ["menu_id" => "85", "role_id" => "5"],
            ["menu_id" => "86", "role_id" => "5"],
            ["menu_id" => "87", "role_id" => "5"],
            ["menu_id" => "88", "role_id" => "5"],
            ["menu_id" => "89", "role_id" => "5"],
            ["menu_id" => "90", "role_id" => "5"],

            // Menu Accounting
            ["menu_id" => "91", "role_id" => "7"],
            ["menu_id" => "92", "role_id" => "7"],
            ["menu_id" => "93", "role_id" => "7"],
            ["menu_id" => "94", "role_id" => "7"],
            ["menu_id" => "95", "role_id" => "7"],
